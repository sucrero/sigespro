    ...
    <head>
        ...
        <script type="text/javascript">
            dw_Tooltip.content_vars = {
                 L21: 'Seleccione una Comunidad',
                L22: 'Ingrese el Nombre del Sector',
                L23: 'Ingrese la Direcci&oacute;n del Sector'
            }
        </script>
        <script type="text/javascript">
            addLoadEvent(mostrarTodoS);
            addLoadEvent(foco,'0');
        </script>
