...
<!--<input id="ingresarcomunidad" type="button" value="Ingresar" onClick="displayMessage('comunidad.php')" tabindex="5"><span class="hint">Seleccione o Ingrese una Comunidad<span class="hint-pointer">&nbsp;</span></span></td>-->
                                  ...
                                  <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="3">
                                                <table border="0px" cellpadding="0px" cellspacing="0px" width="58%">
                                                    <tr>
                                                        <td  width="60%" align="left">
                                                            <input type="text" maxlength="8" style="width:100px" id="itxtcedEstGru" tabindex="16" class="tooltip" title="Ingrese una C&eacute;dula, m&aacute;ximo 8 d&iacute;gitos">&nbsp;
                                                            <input id="buscarEstGru" type="button" onClick="buscarAgreEstu();" tabindex="17" value="Buscar" class="tooltip" title="Presione aqu&iacute; para buscar un Estudiante" style="width:70px;">
                                                            <!--<input id="seleccionargrupo" type="button" onClick="abrirGrupo('formDiagnostico');" tabindex="17" value="Buscar y Agregar" class="tooltip" title="Presione aqu&iacute; para formar un grupo" style="width:70px;">-->
                                                            <input type="hidden" id="itxtgrupo" value="">
                                                            <input type="hidden" id="itxtgrupoMod" value="">
                                                            <input type="hidden" id="itxtgrupoTable" value="">
                                                        </td>
                                    ...
                                    <table width="100%" cellpadding="1" border="0" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="3">
                                                <input type="text" maxlength="8" style="width:100px" id="ceddocente" tabindex="16" class="tooltip" title="Ingrese una C&eacute;dula, m&aacute;ximo 8 d&iacute;gitos">&nbsp;
                                                <input id="buscarProfesores" type="button" onClick="buscarDocente('D');" tabindex="17" value="Buscar" class="tooltip" title="Presione aqu&iacute; para buscar" style="width:70px;">
                                                <input type="text" style="width:250px" id="nomdocente" tabindex="16" class="tooltip" title="Nombre del docente">&nbsp;
                                                <input type="hidden" id="ilstdocente">
                                            </td>
<!--                                            <td align="left" colspan="3"><select id="ilstdocente" tabindex="20" style="width: 300px" class="mayuscula tooltip" title="Seleccione un docente" disabled>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="3">
                                                <input type="text" maxlength="8" style="width:100px" id="cedtutor" tabindex="16" class="tooltip" title="Ingrese una C&eacute;dula, m&aacute;ximo 8 d&iacute;gitos">&nbsp;
                                                <input id="buscarTutores" type="button" onClick="buscarDocente('T');" tabindex="17" value="Buscar" class="tooltip" title="Presione aqu&iacute; para buscar" style="width:70px;">
                                                <input type="text" style="width:250px" id="nomtutor" tabindex="16" class="tooltip" title="Nombre del tutor">&nbsp;
                                                <input type="hidden" id="ilsttutor">
                                            </td>
<!--                                            <td align="left" colspan="3">
