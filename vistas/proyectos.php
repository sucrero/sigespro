...
<div id="dialogProy" class="window">
        	...
        	<table width="750px" border="0" cellspacing="0" cellpadding="0" align="center" class="bordeyfondogris">                        
                        <tr>
                            ...
                            <td width="700px"><span class="titulosgrandesAzules">[ Buscar Proyectos ]</span></td>
                        </tr>
                        <tr>
                            <td class="FondoAzulLetrasBlancaTABLAS" align="center" colspan="2">
                                B&uacute;sque o seleccione el t&iacute;tulo del Proyecto a evaluar</td>
                        </tr>
                        <tr>
                                ...
                                <form id="formMostProy" method="post">
                                    <table width="100%" border="0" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif">
                                        ...
                                        <tr>
                                            ...
                                            <td width="65%" align="left"><input id="txtbusproy" onkeyup="buscarProyLe(this,event)" type="text" tabindex="1" maxlength="150" style="width:300px" class="mayuscula" /><input type="hidden" id="txtpnf" value="<?php echo $_GET['pnf']; ?>"></td>                                   
                                        <tr>
                                            <td width="35%" align="right" colspan="2">
                                <div id="div_proy" class="area3" style="display:block; overflow:auto;"  align="center">
...
//                document.formMostProy.txtbusproy.focus();
            </script>
</div>
